...
\begin{itemize}
    ...
    Chothia et al. führen eine kryptographische Formalanalyse des ERTMS-Protokollstapels (GSM-R, EuroRadio, ETCS Application Layer) durch \parencite[S. 743--756]{chothiaAttack2017}. Sie weisen nach, dass die EuroRadio-MAC-Konstruktion aufgrund der geringen Blocklänge (64 Bit) und des Einsatzes von Single-DES anfällig für kollisionsbasierte Key-Recovery-Angriffe ist. Dadurch können Angreifer nach dem Beobachten von MAC-Kollisionen gefälschte \textit{Movement Authorities} (z. B. in Paket 72) injizieren \parencite[S. 751--754]{chothiaAttack2017}. Diese Arbeit bildet in der vorliegenden Hausarbeit die empirische Evidenz für die kryptographischen Schwachstellen der europäischen Bestandsinfrastruktur.
