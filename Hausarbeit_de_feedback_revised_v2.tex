...
\begin{figure}[htbp!]
\centering
\includegraphics[width=0.7\textwidth]{res/Bahn_Infrastruktur.jpg}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{res/ECTS_Level2.jpg}
    \caption{\gls{etcs} \textit{Level} 2~\cite{arcETCS}}
    \label{fig:ETCS-level-2}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{res/ECTS_Level3.jpg}
